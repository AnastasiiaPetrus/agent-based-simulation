...
<section class="hero-copy">
  ...
  <p class="hero-subtitle">
    <em>What should we do</em> with that information?<br>Run a synthetic population of 1,000 children through three policies &mdash;<br>and watch what a few percentage points of error actually cost.</em>
  </p>
</section>
        """
    )
